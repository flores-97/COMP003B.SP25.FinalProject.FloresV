...
namespace COMP003B.SP25.FinalProject.FloresV.Controllers
{
    public class MembersController : Controller
    {
        ...
        public MembersController(WebDevAcademyContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("MemberId,Name,Email,Age")] Member member)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MemberId,Name,Email,Age")] Member member)
        {
